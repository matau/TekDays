                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'organizer', 'errors')}">
                                    <g:select name="organizer.id" from="${at.isong.TekUser.list()}" optionKey="id" value="${tekEventInstance?.organizer?.id}"  />
                                </td>
                            </tr>
...
<g:link controller="message" action="create" params="['tekEvent.id': tekEventInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'message.label', default: 'Message')])}</g:link>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'volunteers', 'errors')}">
                                    <g:select name="volunteers" from="${at.isong.TekUser.list()}" multiple="yes" optionKey="id" size="5" value="${tekEventInstance?.volunteers}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="responders"><g:message code="tekEvent.responders.label" default="Responders" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: tekEventInstance, field: 'responders', 'errors')}">
